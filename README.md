...
Distributed systems, Kubernetes internals, distributed configuration and service discovery, web infrastructure, developer tooling, AI applications, AI coding and evaluation harnesses, and open-source communities.
